                    ...
                    <AnimatePresence>
                      {activeDropdown === link.name && (
                        <motion.div
                          ...
                          exit={{ opacity: 0, y: 10 }}
                          className="absolute top-full left-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-2"
                        >
                  ...
                  {link.dropdown ? (
                    <div>
                      <button
                        ...
                        className={`flex items-center justify-between w-full text-base font-medium transition-colors hover:text-blue-600 dark:hover:text-blue-400 ${
                          location.pathname.startsWith(link.href)
                            ? 'text-blue-600 dark:text-blue-400'
                            : 'text-gray-700 dark:text-gray-300'
                        }`}
